...
// import { useState } from 'react';
// import { User, Phone, Mail, MapPin, FileText, BookUser, MessageSquare, CreditCard } from 'lucide-react';
...
//     e.preventDefault();
//     if (!isValid()) {
//       alert("Please fill all required fields correctly (e.g., valid contact, email, transaction ID).");
//       return;
//     }
...
//         <div
//           key={i}
//           className="absolute w-2 h-2 rounded-full bg-indigo-300/30 animate-pulse"
//           style={{
//             top: `${Math.random() * 100}%`,
...
//       <div className="w-full max-w-lg backdrop-blur-sm bg-white/90 border border-gray-200/60 shadow-2xl rounded-xl animate-fade-in">
//         <div className="text-center space-y-2 p-6 pb-4">
//           <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
//             Course Registration
//           </h1>
//           <p className="text-gray-600">Join our professional development courses</p>
//         </div>
...
//                   {label}
//                 </label>
//                 <div className="flex items-center border border-gray-300 rounded-lg bg-white px-3 py-2 focus-within:ring-2 focus-within:ring-indigo-500">
//                   {icon}
//                   <input
//                     id={id}
//                     name={id}
...
//                 onChange={handleInputChange}
//                 required
//                 className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 hover:border-gray-400"
//               >
//                 <option value="">Select your interest</option>
//                 <option value="Web Designing">Web Designing</option>
//                 <option value="Shopify">Shopify</option>
...
//             <div className="bg-indigo-50/80 p-4 rounded-lg text-center border border-indigo-100">
//               <p className="text-sm text-gray-600">Send 500 PKR to SADA Pay: <strong>0323 6762115</strong></p>
//             </div>
//             <div className="space-y-2">
//               <label htmlFor="transactionId" className="block text-sm font-medium text-gray-700">Transaction ID</label>
//               <div className="flex items-center border border-gray-300 rounded-lg bg-white px-3 py-2 focus-within:ring-2 focus-within:ring-indigo-500">
...
//               </label>
//               <div className="flex items-start border border-gray-300 rounded-lg bg-white px-3 py-2 focus-within:ring-2 focus-within:ring-indigo-500">
//                 <MessageSquare className="mt-1" size={18} />
//                 <textarea
//                   id="message"
//                   name="message"
...
//             {/* Starting Info */}
//             <div className="bg-indigo-50/80 p-4 rounded-lg text-center border border-indigo-100">
//               <p className="text-sm font-bold text-indigo-600">Classes Starting from 16 August</p>
//             </div>
